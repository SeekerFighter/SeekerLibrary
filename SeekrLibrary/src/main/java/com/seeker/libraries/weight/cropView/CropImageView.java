...
package com.seeker.libraries.weight.cropView;
...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mCropOverlayView = new CropOverlayView(getContext());
        ...
        mCropOverlayView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        mCropOverlayView.setVisibility(INVISIBLE);
        addView(mCropOverlayView);
